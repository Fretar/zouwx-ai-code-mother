...
import com.zouwx.zouwxaicodemother.mapper.UserMapper;
import com.zouwx.zouwxaicodemother.model.enums.UserRoleEnum;
...
import com.zouwx.zouwxaicodemother.utils.NicknameGenerator;
...
import static com.zouwx.zouwxaicodemother.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public User getLoginUser(HttpServletRequest request) {
        ...
        // 2. 从数据库中查询当前用户登录信息，减少后期因为缓存原因导致用户登录信息不新的问题
