package com.zouwx.zouwxaicodemother.service.impl;
...
import com.zouwx.zouwxaicodemother.ai.AiCodeGenTypeRoutingService;
import com.zouwx.zouwxaicodemother.ai.AiCodeGenTypeRoutingServiceFactory;
import com.zouwx.zouwxaicodemother.constant.AppConstant;
import com.zouwx.zouwxaicodemother.core.AiCodeGeneratorFacade;
import com.zouwx.zouwxaicodemother.core.builder.VueProjectBuilder;
import com.zouwx.zouwxaicodemother.core.handler.StreamHandlerExecutor;
...
import com.zouwx.zouwxaicodemother.mapper.AppMapper;
import com.zouwx.zouwxaicodemother.model.entity.User;
import com.zouwx.zouwxaicodemother.model.enums.ChatHistoryMessageTypeEnum;
...
import com.zouwx.zouwxaicodemother.service.AppService;
import com.zouwx.zouwxaicodemother.service.ScreenshotService;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public Flux<String> chatToGenCode(Long appId, String message, User loginUser) {
        ...
        // 5. 在调用 AI 前，保存用户消息到数据库中
        chatHistoryService.addChatMessage(appId, message, ChatHistoryMessageTypeEnum.USER.getValue(), loginUser.getId());
        // 6. 调用 AI 生成代码（流式）
        Flux<String> codeStream = aiCodeGeneratorFacade.generateAndSaveCodeStream(message, codeGenTypeEnum, appId);
        // 7. 收集 AI 响应的内容，并且在完成后保存记录到对话历史中
